...
def start_secure_grpc_server(
    ...
    server = grpc.server(
        ...
        options=[
            ...
            ("grpc.max_send_message_length", max_message_length),
            ("grpc.max_receive_message_length", max_message_length),
            #('grpc.ssl_target_name_override', 'flakeaggcore.com'),
            #('grpc.default_authority', 'flakeaggcore.com'),
        ],
    )
    ...
    server.add_secure_port(server_address,credential)
    server.start()
