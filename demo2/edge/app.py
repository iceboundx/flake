...
from grpc_server import start_insecure_grpc_server,start_secure_grpc_server
...
def start_server(
    ...
    # Start gRPC server
    with open(key_prefix+'.key', 'rb') as f:
        private_key = f.read()
    with open(key_prefix+'.crt', 'rb') as f:
        certificate_chain = f.read()

    server_credentials = grpc.ssl_server_credentials( ( (private_key, certificate_chain), ) )
    grpc_server = start_secure_grpc_server(
