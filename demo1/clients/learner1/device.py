...
ConnectUrl="http://192.168.31.227:8080/connect"

class Device:

    def first_connect(self,url):
        print("Start First Connection")
        postdatas = {'id': self._twin.name,'node':self._edge_name}
        res = requests.post(url, data=postdatas)
...
def main():
    l1=Device("newlearner123","192.168.31.10",1883,"raspberrypi")
    res=l1.start_edge()
    print(res)
    while True:
        x=input()
